    ...
    <>
      <div className="about-us-container">
        <section className="top-section bg-white text-left flex justify-center items-center h-64">
          <div className="text-container">
            <h1 className="text-orange-500 md:text-5xl  font-bold leading-snug1">
        ...
        <section className="top-section bg-grey text-left flex justify-center items-center h-64">
          <div className="text-container">
            <h1 className="text-white md:text-5xl font-bold leading-snug2">
        ...
        <section className="bg-white text-center py-12 px-4">
          <h2 className="text-333333 md:text-5xl font-bold leading-tight">
          ...
          <div className="video-container w-3/4 mt-8">
            <iframe
      ...
      <div className="p-6 bg-white">
        <div className="bg-white p-6">
          <div className="flex flex-col md:flex-row ml-36">
            ...
            <div className="md:w-3/4 md:pl-6 mt-6 ml-16 md:mt-0">
              <div className="mb-4 md:w-3/4">
                <h1 className="text-4xl font-bold">WHO WE <span className="text-orange-600">ARE</span></h1>
              ...
              <div className="mb-4 mt-8 md:w-3/4">
                <h2 className="text-4xl font-bold text-orange-600">OUR <span className="text-333333">STUDENTS</span> COME FIRST</h2>
                <p className="text-gray-700 text-lg leading-relaxed">
          ...
          <div className="mt-24">
            <h2 className="text-5xl card-heading1 font-bold">
              At <span className="text-orange-600">Admit Achievers</span> Our Core Values
            </h2>
            
            <h2 className="text-5xl card-heading2 font-bold">
              Guide Our 
            ...
            <div className="flex w-3/4 ml-36 flex-wrap items-center justify-center mt-8 space-y-4 md:space-y-0">
              {cards.map((card, index) => (
                <div key={index} className="w-full md:w-1/3 p-4 box-border">
                  <div className="bg-white shadow-lg text-xl p-6 rounded-lg text-center h-48 flex items-center justify-center">
      ...
      <div className="about-us-container">
        <section className="accreditations-section overflow-hidden bg-white text-center py-12">
          <h2 className="text-black text-5xl font-bold leading-tight mb-4">
