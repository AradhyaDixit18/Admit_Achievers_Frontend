    ...
    return(
            ...
            <div className="relative text-black main">
                ...
                <div id="how-we-work" className="section-container">
                    <div className="text-section  ml-24 mt-16">
                ...
                <div id="document-editing" className="section-container">
                    <div className="flex flex-col md:flex-row mt-4">
                        <div className="p-4 flex flex-wrap relative">
                ...
                <div id="visa-services" className="section-container">
                    <div className="text-left">
                        <h2 className="text-5xl font-bold mb-4 ml-16 mt-16">Visa Services</h2>
                        <p className="mb-4 ml-16 mr-16">
                        ...
                        <button className="custom-button">Start Your Admission Journey</button>
                    </div>
                </div>
